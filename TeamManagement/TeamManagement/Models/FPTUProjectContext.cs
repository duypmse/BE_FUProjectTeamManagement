...
namespace TeamManagement.Models
{
    public partial class FPTUProjectContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("server =(projectmanagement.c4izale5z03d.ap-southeast-1.rds.amazonaws.com,1433); database = DB=FPTUProject;uid=admin;pwd=123456789;");
            }
        }
